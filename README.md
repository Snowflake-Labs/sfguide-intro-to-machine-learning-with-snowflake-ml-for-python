...
## Overview
Through this quickstart guide, you will explore Snowflake's native capabilities for Machine Learning. You will build a simple ML workflow from feature engineering to model training and deployment using Snowflake ML in Snowflake Notebooks.
